...
<div class="wrapper">
	<header class="main-header">
		<a href="home-admin.php" class="logo"><span class="logo-mini">PASS</span><span class="logo-lg"><b>Pass</b> Keeper</span></a>
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview"><a href="#"><i class="fa fa-book"></i> <span>Master Data</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						...
						<li><a href="home-admin.php?page=form-master-password"> <i class="fa fa-caret-right"></i> Password</a></li>
					</ul>
				</li>
			</ul>
		</section>
